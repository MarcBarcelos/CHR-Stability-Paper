...
TD_FP, SEM_FP, LING_FP = OUT_DIR / "checkpoints" / "td_checkpoint.csv", OUT_DIR / "checkpoints" / "sem_checkpoint.csv", OUT_DIR / "checkpoints" / "ling_checkpoint.csv"
OUT_FP = OUT_DIR / "outputs" / "AO3metrics_full.csv"

cfg = MetricsConfig(affect_mode="modern")
